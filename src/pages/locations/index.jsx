...
function Locations() {
  ...
  //   const { success } = isUpdate ? await putRequest.request({ url: locationsPut(isUpdate), data }) : await postRequest.request({ data })
  //   console.log(data);
  //   if (success) {
  //     reload()
  //     form.resetFields()
  ...
  //       <Col span={16} >
  //         <Table dataSource={locations?.locations} columns={columns} loading={loading} rowKey='id' ></Table>
  //       </Col>
  //     </Row>
  //   </Card>
  // </>
